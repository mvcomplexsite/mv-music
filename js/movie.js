import { getMovie, getReviews, getSimilarMovies } from './api.js?v=19';
import { getWatchUrl } from './config.js?v=19';
import { imageUrl, imageAttrs, bindImageFallbacks } from './images.js?v=19';
import { hasInList, toggleInList, isWatchNoticeDismissed, dismissWatchNotice } from './storage.js?v=19';
