import { getProfile, saveProfile, clearProfile, counts } from './storage.js?v=19';
...
async function registerServiceWorker() {
  ...
  try { await navigator.serviceWorker.register('./sw.js?v=19'); } catch (error) { console.warn('PWA service worker:', error); }
}
